 ...
 *   https://datatables.net/download/#bs4/dt-1.10.21/e-1.9.4/b-1.6.2/r-2.2.5/sl-1.3.1
 *
 * Included libraries:
 *   DataTables 1.10.21, Editor 1.9.4, Buttons 1.6.2, Responsive 2.2.5, Select 1.3.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.21/e-1.9.4/b-1.6.2/r-2.2.5/sl-1.3.1",
