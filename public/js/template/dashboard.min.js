...
function debounce(i, n, t) {
    ...
    if (-1 < navigator.platform.indexOf("Win")) {
        ...
        0 != $navbar_color.length && (whiteDashboard.checkScrollForTransparentNavbar(), $(window).on("scroll", whiteDashboard.checkScrollForTransparentNavbar)), 0 == $full_screen_map.length && 0 == $(".bd-docs").length &&
...
var whiteDashboard = {
    ...
    initMinimizeSidebar: function() {
        0 != $(".sidebar-mini").length && (sidebar_mini_active = !0), $(".minimize-sidebar").click(function() {
            1 == sidebar_mini_active ? ($body.removeClass("sidebar-mini"), sidebar_mini_active = !1, whiteDashboard.showSidebarMessage("Sidebar mini deactivated...")) :
                ($body.addClass("sidebar-mini"), sidebar_mini_active = !0, whiteDashboard.showSidebarMessage("Sidebar mini activated..."));
