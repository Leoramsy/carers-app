                ...
                quake: function (options) {
                    ...
                    return this.each(function () {
                        ...
                        function addNavigationControls() {
                            ...
                            $('.quake-nav-container a').on('click', onNavClick);
                            ...
                            if (settings.thumbnails) {
                                ...
                                $('.quake-nav-container a').on('mouseenter', function () {
                                ...
                                $('.quake-nav-container a').on('mouseleave', function () {
                        ...
                        function animateBoxFadeOutOriginal(rotate) {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateBoxFadeOutOriginal');
                            }
                            ...
                            var divImage = $('<div/>').css({
                                ...
                                backgroundSize: sliderWidth + 'px ' + sliderHeight + 'px',
                                backgroundPosition: 'center',
                                backgroundRepeat: 'no-repeat',
                                position: 'absolute',
                                width: '100%', //07/04/2018
                                height: '100%' //07/04/2018
                            }).addClass('quake-fi');
                        ...
                        function animateBoxFadeIn() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateBoxFadeIn');
                            }
                            var boxes = circles * 2;
                            ...
                            for (var i = 0; i < boxes; i++) {
                                ...
                                var box = $('<div/>').css({backgroundImage: 'url(' + getImageSrc(images[imageIndex]) + ')', backgroundSize: sliderWidth + 'px ' + sliderHeight + 'px', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', left: positionLeft, top: positionTop, position: 'absolute', width: width, height: width, opacity: 0}).addClass('quake-el');
                        ...
                        function animateSwirlFadeOut() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateSwirlFadeOut');
                            }
                            var divImage = $('<div/>').css({
                                zIndex: 1,
                                backgroundImage: 'url(' + getImageSrc(currentImage) + ')',
                        ...
                        function animateSwirlFadeOutRotate(toggle) {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateSwirlFadeOutRotate');
                            }
                            var divImage = $('<div/>').css({
                                zIndex: 1,
                                backgroundImage: 'url(' + getImageSrc(currentImage) + ')',
                        ...
                        function animateDiagonally(reverse, animateSize) {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateDiagonally');
                            }
                            var w = Math.ceil(sliderWidth / cols);
                            var h = Math.ceil(sliderHeight / rows);
                        ...
                        function animateBlind() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateBlind');
                            }
                            var bars = wBars;
                        ...
                        function animateSlabs() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateSlabs');
                            }
                            var bars = wBars;
                            var w = sliderWidth / bars;
                            if (w % 10 != 0)
                        ...
                        function animateBlindHorizontal() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateBlindHorizontal');
                            }
                            var bars = hBars;
                        ...
                        function animateBlindFade() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateBlindFade');
                            }
                            var bars = wBars;
                            var w = sliderWidth / bars;
                            if (w % 10 != 0)
                        ...
                        function animateBlindFadeReverse() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateBlindFadeReverse');
                            }
                            var bars = wBars;
                            var w = sliderWidth / bars;
                            if (w % 10 != 0)
                        ...
                        function animateFallingBlindFade() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateFallingBlindFade');
                            }
                            var bars = hBars;
                            var h = sliderHeight / bars;
                            if (h % 10 != 0)
                        ...
                        function animateRaisingBlindFade() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateRaisingBlindFade');
                            }
                            var bars = hBars;
                            var h = sliderHeight / bars;
                            if (h % 10 != 0)
                        ...
                        function animateMixBars() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateMixBars');
                            }
                            var bars = wBars;
                            timeFactor = animationSpeed / bars;
                            for (var i = 0; i < bars; i++) {
                        ...
                        function animateMixBarsFancy() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateMixBarsFancy');
                            }
                            var bars = wBars;
                            timeFactor = animationSpeed / bars;
                            for (var i = 0; i < bars; i++) {
                        ...
                        function animateBarsDown(reverse) {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateBarsDown');
                            }
                            var bars = wBars;
                            timeFactor = animationSpeed / bars;
                            if (previousImage == null)
                        ...
                        function animateBarUp() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateBarUp');
                            }
                            var bars = wBars;
                            timeFactor = animationSpeed / bars;
                            for (var i = 0; i < bars; i++) {
                        ...
                        function animateExplode() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateExplode');
                            }
                            timeFactor = animationSpeed / noOfBoxes;
                            var w = Math.ceil(sliderWidth / cols);
                            var h = Math.ceil(sliderHeight / rows);
                        ...
                        function animateExplodeFancy() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateExplodeFancy');
                            }
                            timeFactor = animationSpeed / noOfBoxes;
                            var w = Math.ceil(sliderWidth / cols);
                            var h = Math.ceil(sliderHeight / rows);
                        ...
                        function animateFade() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateFade');
                            }
                            $('<div/>').css({
                                width: sliderWidth,
                                height: sliderHeight,
                        ...
                        function animateSlideIn(reverse) {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateSlideIn');
                            }
                            var bars = hBars;
                        ...
                        function animateSlideInFancy() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateSlideInFancy');
                            }
                            var bars = hBars;
                            //reconsider this condition
                            if (wBars - hBars >= wBars / 2) {
                        ...
                        function animateChop(animateSize, diagonal, reverse) {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateChop');
                            }
                            var w = Math.ceil(sliderWidth / cols);
                            var h = Math.ceil(sliderHeight / rows);
                            var bars = hBars / 2;
                        ...
                        function animateSlideLeft() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateSlideLeft');
                            }
                        ...
                        function animateSlideRight() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateSlideRight');
                            }
                            var cImage = $('<div/>').addClass('quake-el').css({
                                width: sliderWidth,
                                height: sliderHeight,
                        ...
                        function animateSlideDown() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateSlideDown');
                            }
                            var cImage = $('<div/>').addClass('quake-el').css({
                                width: sliderWidth,
                                height: sliderHeight,
                        ...
                        function animateSlideUp() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': animateSlideUp');
                            }
                            var cImage = $('<div/>').addClass('quake-el').css({
                                width: sliderWidth,
                                height: sliderHeight,
                        ...
                        function createBoxes() {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': createBoxes'); //TODO: Problem child (maybe animateChop)
                            }
                        ...
                        function createCircles(imageIndex) {
                            if (consoleLog) {
                                console.log(sliderContainer.attr('class') + ': createCircles');
                            }
                            ...
                            if (minCircumeference % 2 != 0 && imageIndex != currentImageIndex)
                                minCircumeference++;
                            zindex = 100;
                            timeFactor = animationSpeed / circles;
                            for (var i = 0; i < circles; i++) {
                                ...
                                var positionTop = centerTop - width / 2;
                                var radius = (i + 1) * minCircumeference;
                                var box = $('<div/>').css({backgroundImage: 'url(' + getImageSrc(images[imageIndex]) + ')', backgroundSize: sliderWidth + 'px ' + sliderHeight + 'px', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', left: positionLeft, top: positionTop, position: 'absolute', width: width, height: width, zIndex: zindex--, opacity: 0}).addClass('quake-el');
