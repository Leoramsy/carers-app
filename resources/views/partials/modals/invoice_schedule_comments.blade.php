<!-- Modal -->
<div id="invoice-comments-modal" class="modal fade" role="dialog" >
    <div class="modal-dialog modal-dialog-centered" role="document"  style="max-width: 900px; width: 900px">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-light">Schedule <span id="invoice-schedule-header"></span> Comments</h4>
            ...
            <div class="modal-body">
                <div class="container">
                    <form id="invoice-comments-form" class="mb-2">
                        <div class="col-md-12">                          
                            {!! Form::hidden('invoice_schedule_id', 0, array('id' => 'invoice-schedule-id', 'class' => 'form-control input-original', 'readonly' => 'true')) !!}  
            ...
            <div class="modal-footer col-md-12">
                <div class="col-md-10" style="padding-left: 35px;">
                    @can('schedule_updates')<button id='invoice-comments-add' class="btn" style="float: left">Add Comment</button>@endcan
                    <button id='invoice-comments-refresh'  class="btn" style="float: left">Refresh</button>         
                </div>
                <div class="col-md-2" style="padding-right: 30px;">
                    <button id='invoice-comments-cancel' type="button" class="btn" data-dismiss="modal" style="float: right">Close</button>
                </div>
            </div>
        </div>
    </div>
